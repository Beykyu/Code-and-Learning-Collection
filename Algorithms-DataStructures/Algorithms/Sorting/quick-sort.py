...
def quick_sort(lst : List[Any], lower : int, upper : int, comp_func : Callable[[Any, Any],Any] = ascending) -> List[Any]:
    ...
    if upper > lower:
        ...
        quick_sort(lst, lower, pivot_index - 1, comp_func)        # Sort left of pivot
...
def partition(lst : List[Any], lower : int, upper : int, comp_func : Callable[[Any, Any],Any] = ascending) -> int:
    ...
    """
    pivot = lst[upper]      # Choose last element as pivot
...
def main():
    ...
    print("Before:", test1)
    print("After:", quick_sort(test1.copy(), 0, len(test1) - 1))
    
    # Test case 2: Already sorted list
    test2 = [1, 2, 3, 4, 5]
    print("\nTest 2 - Already sorted:")
    print("Before:", test2)
    print("After:", quick_sort(test2.copy(), 0, len(test2) - 1))
    
    # Test case 3: Reverse sorted list
    test3 = [5, 4, 3, 2, 1]
    print("\nTest 3 - Reverse sorted:")
    print("Before:", test3)
    print("After:", quick_sort(test3.copy(), 0, len(test3) - 1))
    
    # Test case 4: Empty list
    test4 = []
    print("\nTest 4 - Empty list:")
    print("Before:", test4)
    print("After:", quick_sort(test4.copy(), 0, len(test4) - 1))
    
    # Test case 5: List with one element
    test5 = [1]
    print("\nTest 5 - Single element:")
    print("Before:", test5)
    print("After:", quick_sort(test5.copy(), 0, len(test5) - 1))
    
    # Test case 6: List with duplicate elements
    test6 = [1, 1, 1, 1, 1]
    print("\nTest 6 - All duplicates:")
    print("Before:", test6)
    print("After:", quick_sort(test6.copy(), 0, len(test6) - 1))
    
    # Test case 7: List with negative numbers
    test7 = [-5, 3, -10, 0, 8, -2]
    print("\nTest 7 - Negative numbers:")
    print("Before:", test7)
    print("After:", quick_sort(test7.copy(), 0, len(test7) - 1))
    
    # Test case 8: Testing descending order
    test8 = [1, 5, 2, 8, 3]
    print("\nTest 8 - Descending order:")
    print("Before:", test8)
    print("After:", quick_sort(test8.copy(), 0, len(test8) - 1 , descending))
